...
output: pdf_document
---
```{r initialize, include=FALSE, cache=TRUE, eval=TRUE, echo=FALSE}
require(knitr)
...
knitr::opts_chunk$set(echo = FALSE, include = TRUE, cache = TRUE, eval=TRUE)
#knitr options are:
...
which attribute, if any, we should remove, and the answer turns out to be baths.
But for now, we'll leave them in the data.
```{rattribute_correation_removal, echo=TRUE}
```
