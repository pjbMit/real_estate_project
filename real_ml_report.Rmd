...
which attribute, if any, we should consider removing to see if our models improve...
 and the answer turns out to be baths.  But for now, we opted not to remove baths from the model.
...
```{r model_output_1, include=TRUE}

```

And here are the results of the output.
# ```{r models_compare1, echo=TRUE, include=TRUE, eval=TRUE, cache=FALSE}
# ```
